    ...
    public class TestController : Controller
    {
        ...
        public async Task Execute(string ref_code, StudentTestInfo studentTestInfo)
        {
            try
            {
                ...
                var msg = MailHelper.CreateSingleEmailToMultipleRecipients(from, emails, subject, plainTextContent, htmlContent, true);
                ...
                pdfAttachment.Filename = studentTestInfo.Name + "_" + studentTestInfo.TestDate + "_Test_Results.pdf";
        ...
        {
            //AdhyapanDB adhyapanDB = new AdhyapanDB();
            Student studentDetail = adhyapanDB.GetStudentDetails("wIDewRoRN0660Gnu3xj92g==");
            Session["Reference_Code"] = "wIDewRoRN0660Gnu3xj92g==";
        ...
        public ActionResult LoadEmotionalRegulationTestInstructionTest()
        {
            ...
            string reference_Code = "gTEeTEMDckC6pqer5BsZBA==";
            //string reference_Code = Encoding.UTF8.GetString(Reference_Code_Byte);
            //AdhyapanDB adhyapanDB = new AdhyapanDB();
            Student studentDetail = adhyapanDB.GetStudentDetails(reference_Code);
